...
- **重子（三夸克）**：三个三角形环嵌套成更大的三角形闭合结构，整体相位和为 $360^\circ$（无色）；
...
- 三个三角形环（上、上、下夸克）通过共享节点堆叠成一个四面体结构（4个节点、6条边）；
- 每个三角形环各占一个面，整体呈“无色”；
...
- **几何应力决定核大小与形状**：边长 $L_{ij}$ 由几何应力 $S_g$ 决定——强相互作用等效为“边上的张力”，使核半径保持在约 $1.24 A^{1/3}$ fm；
...
4. 产物：氘核框架；
5. 重复过程：氢 $\rightarrow$ 氘 $\rightarrow$ 氦-3 $\rightarrow$ 氦-4（四面体结构）$\rightarrow$ 碳 $\rightarrow$ 氧 $\rightarrow$ …… $\rightarrow$ 铁。
