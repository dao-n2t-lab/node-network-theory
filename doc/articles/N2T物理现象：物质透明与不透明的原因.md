...
- **驻波模式分布**：
    - 外层电子（自由电子）在金属中形成**离域化驻波模式**
    - 这些离域化模式跨越整个材料，具有**连续的频率分布**
...
> **玻璃的节点网络在可见光频段内没有可匹配的驻波模式，行波自由通过；金属的节点网络在可见光频段内有连续分布的离域化驻波模式，行波与模式匹配后被吸收或反射。两者的区别来自外层电子驻波的相位耦合状态——金属中原子之间的“共同语言”强（离域化），玻璃中“共同语言”弱（局域化）。**
